...
const PACKAGES_DIR = path.resolve( __dirname, './node_modules/@wordpress' );
...
const SCSS_OUT_PATH = path.resolve('./src/styles/packages/')
...
function getScssOutputPath(file){
	const name = file.split('@wordpress/')[1].replace('src/','').split(path.sep).join('-')
	return path.resolve(SCSS_OUT_PATH,name)
...
function getBuildPath( file, buildFolder ) {
	...
	// console.log('pkgSrcPath : ',pkgSrcPath)
	// console.log('pkgBuildPath : ', pkgBuildPath)
	// console.log('relativeToSrcPath : ',relativeToSrcPath)

	// return path.resolve(SCSS_OUT_PATH)
...
function buildScssFile( styleFile ) {
	const outputFile = getScssOutputPath( styleFile.replace( '.scss', '.css' ) )
  const outputFileRTL = getScssOutputPath( styleFile.replace( '.scss', '-rtl.css' ), BUILD_DIR.style );

	mkdirp.sync( path.dirname( outputFile ) );
	const builtSass = sass.renderSync( {
		file: styleFile,
		includePaths: [ path.resolve( __dirname, '../../src/overrides/stylesheets' ) ],
		data: (
			[
				'colors',
				'breakpoints',
...
// file :  /Users/qi/mygit/Q-gutenberg/node_modules/@wordpress/nux/src/style-rtl.css
// pkgName :  ..
// pkgSrcPath :  /Users/qi/mygit/Q-gutenberg/build/packages/node_modules/src
// pkgBuildPath :  /Users/qi/mygit/Q-gutenberg/build/packages/node_modules/build-style
// relativeToSrcPath :  ../../../../node_modules/@wordpress/nux/src/style-rtl.css
// outputFile /Users/qi/mygit/Q-gutenberg/node_modules/@wordpress/nux/src/style.css
